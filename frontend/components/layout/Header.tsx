...
export default function Header() {
  ...
  const wishlistCount = useWishlistStore((state: WishlistStore) => state.getItemCount());
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <Link href="/" className="flex-shrink-0">
            <div className="text-2xl font-bold text-primary">HIRA𓊆𓊇JEWELS</div>
          </Link>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="icon" className="relative" asChild>
              <Link href="/wishlist">
                <Heart className={wishlistCount > 0 ? "h-5 w-5 fill-primary text-primary" : "h-5 w-5"} />
                {mounted && wishlistCount > 0 && (
                  <span className="absolute -top-1 -right-1 h-5 min-w-5 rounded-full bg-primary text-primary-foreground text-xs flex items-center justify-center px-1">
                    {wishlistCount}
                  </span>
                )}
              </Link>
